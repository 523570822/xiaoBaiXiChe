...
//                }
    ...
    public function CarWashOrder () {
        ...
        //接收数据
        $request = I ('post.');
        //$this->apiResponse('0',$request['mc_code'].'-'.$request['o_type'].'-'.$request['w_type']);
...
//        $post['methodID'] = 0;    //折扣卡ID
        ...
        $wash_money =  bcmul($details['washing'] , $car['washing_money'],3);    //水枪金额
        $foam_money = bcmul($details['foam'] , $car['foam_money'],3); //泡沫枪金额
        $cleaner_money = bcmul($details['cleaner'] , $car['cleaner_money'],3); //吸尘器金额
